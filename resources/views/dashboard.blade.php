          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Action Required</p>
                    <p class="mb-0">
...
@foreach ($result as $item => $category)
@php
  $randomIcon = $icons[array_rand($icons)];
@endphp

<div class="col-xl-3 col-sm-6 mb-4 p-2">
    <a href="{{route('user.productbyId' , ['id' => $category['category_id']])}}">
  <div class="card h-100">
    <div class="card-body p-3 d-flex flex-column justify-content-between">
      <div class="row">
        <div class="col-12">
          <div class="numbers">
            <p class="text-sm mb-0 text-uppercase font-weight-bold">{{ $category['category_name'] }}</p>
            <p class="mb-0">
              <span class="text-success text-sm font-weight-bolder">{{ $category['product_count'] }}</span>
            </p>
          </div>
        </div>
